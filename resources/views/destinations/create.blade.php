<x-layouts.app>
    ...
    <div class="ticket-container flex flex-col items-center w-11/12 max-w-5xl mt-5 bg-transparent shadow-lg">
        <div class="ticket flex flex-col md:flex-row w-full">
            <div class="ticket-left w-full md:w-1/3 text-center flex flex-col justify-center items-center p-5 bg-ticket-left rounded-xl mb-2 md:mb-0 shadow-lg bg-[#DAC7A0]">
            ...
            <div class="ticket-right w-full md:w-2/3 bg-ticket-right p-5 rounded-xl flex flex-col justify-center shadow-lg bg-[#F3E4B3]">
                <div class="content relative">
                    ...
                    <form action="{{ route('destinations.store') }}" method="POST" onsubmit="return validateForm()">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" required class="w-full px-3 py-2 mt-2 border rounded-lg" maxlength="100">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group mb-5">
                            ...
                            <input type="date" id="visit_date" name="visit_date" value="{{ old('visit_date') }}" required class="w-full px-3 py-2 mt-2 border rounded-lg" min="{{ date('Y-m-d') }}">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <select id="reason" name="reason" required class="w-full px-3 py-2 mt-2 border rounded-lg">
                                ...
                                <option value="relatives" {{ old('reason') == 'relatives' ? 'selected' : '' }}>Visit relatives</option>
                                <option value="event" {{ old('reason') == 'event' ? 'selected' : '' }}>Event <i>(eg. concert, sports game, etc.)</i></option>
                        ...
                        <div class="form-group mb-5">
                            ...
                            <input type="text" id="location" name="location" value="{{ old('location') }}" required class="w-full px-3 py-2 mt-2 border rounded-lg" readonly onclick="openMapModal()">
                        ...
                        <button type="submit" class="ticket-button px-6 py-3 text-white bg-[#FFCC00] rounded-md hover:bg-[#E6B800]">Add Destination</button>
    ...
    <script>
        ...
        function initializeMap() {
            ...
            const searchControl = new window.GeoSearchControl({
                provider: provider,
                style: 'bar',
                autoComplete: true,
            ...
            function extractCity(address) {
                ...
                // Further refine city extraction if needed
                if (city.match(/\d/)) {
                    // If the extracted part contains a number, it might not be the city
